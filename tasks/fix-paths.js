...
module.exports = function ($, gulp, merge, order) { return function () {
  var baseBundle, baseBundleJs, indexElement, baseBundleElement, swToolboxSetup;

  if (order === 'before') {
    baseBundle = gulp.src('dist/elements/base-bundle.js')
      .pipe($.replace('("bootstrap/', '("libercus/default/bower_components/platinum-sw/bootstrap/'))
    ...
    baseBundleElement = gulp.src('deploy/elements/base-bundle.*.html')
      .pipe($.replace('"bower_components/', '"libercus/default/bower_components/'))
      .pipe($.replace('"elements/', '"libercus/default/elements/'))
      .pipe($.replace('"images/', '"libercus/default/images/'))
      .pipe($.replace('"scripts/', '"libercus/default/scripts/'))
    ...
    swToolboxSetup = gulp.src('deploy/bower_components/platinum-sw/bootstrap/sw-toolbox-setup.*.js')
      ...
      return merge(baseBundleJs, baseBundleElement, swToolboxSetup);
  }
};};
