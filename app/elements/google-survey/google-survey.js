    ...
    this.dispatchEvent(
      new CustomEvent(
        'load-script',
        {
          ...
          composed: true,
          detail: {
            url: 'http://survey.g.doubleclick.net/survey?site=' + gcsSurveyId + '&url=' + encodeURIComponent(ARTICLE_URL) + (CONTENT_ID ? '&cid=' + encodeURIComponent(CONTENT_ID) : '') + '&random=' + (new Date).getTime() + '&after=1',
            id: 'googleSurveyScript',
            appendToBody: true
          }
        }
      )
